...
| `correspondence_eval.py` | Enron correspondence eval primitives (KANBAN-103): blind↔GT join, subclass-stratified sample, sentiment scoring, predicted↔GT field alignment |
