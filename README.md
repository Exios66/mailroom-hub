...
| [llm-dojo-scoring](https://github.com/Exios66/llm-dojo-scoring) | Deterministic, field-type-aware scoring engine (`@v0.10.0`) | Upstream governed dependency of both pipeline repos |
